...
export const AGENT_CONFIGS: AgentConfig[] = [
  {
    ...
    "triggerEvents": [
      ...
      },
      {
        ...
        "description": "When a user uploads a document for a welfare scheme, the agent automatically analyzes the document for validity."
      },
      {
        "type": "async",
        "name": "eligibility_status_change",
        "description": "When a user profile is updated or a new government scheme is added, the agent evaluates eligibility."
      }
    ],
    "config": {
  ...
  },
  {
    ...
    "description": "A financial guardian for rural users, designed to automate government welfare fund management.",
    "triggerEvents": [
      {
        "type": "async",
        "name": "dbt_deposit_detected",
        "description": "Triggered when a government welfare payment is credited to the account."
      },
      {
        "type": "async",
        "name": "voice_assistance_request",
        "description": "Triggered when a user opens a transaction screen or starts a new process."
      },
      {
        "type": "async",
        "name": "offline_lock_sync",
        "description": "Triggered when the app regains internet connectivity."
      },
      {
        "type": "async",
